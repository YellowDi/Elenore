document.addEventListener('DOMContentLoaded', () => {
  ...
  if ($highlights.length > 0) {
    $highlights.forEach($el => {
      ...
      if ($parent && $parent.classList.contains('el-is-more')) {
        const showEl = '<button class="el-show"><div><span class="icon"><i class="fas fa-code"></i></span> <strong>Show code</strong></div></button>';
  ...
  function addHighlightControls() {
    const $highlightButtons = getAll('.highlight .el-copy, .highlight .el-expand');
    ...
    const $highlightExpands = getAll('.highlight .el-expand');
